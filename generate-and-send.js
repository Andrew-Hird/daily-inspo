...
const PROMPTS = [
	...
	"A Minion punching the air in triumph, Roy Lichtenstein pop art style, halftone dot pattern, primary colours only, bold black outlines, speech bubble saying BAM",
	...
	"A Minion lounging on the deck of a 1930s ocean liner, Art Deco travel poster style, geometric sunburst border, gold and teal palette, bold sans-serif lettering, streamline moderne aesthetic",
	...
	"A Minion dissected as a naturalist scientific illustration, Victorian specimen diagram style, labelled anatomical annotations in copperplate script, sepia ink on cream paper",
	"A Minion portrait as a large-scale graffiti mural on a crumbling brick wall, spray-paint drips, wild style lettering, urban textures, photographed straight-on in daylight",
	...
	"A Minion pointing directly at the viewer, WW2 Uncle Sam poster style, flat graphic colour, bold uppercase typography, patriotic red and yellow palette, heroic upward angle",
	...
	"A Minion rendered as an engineering blueprint, white linework on Prussian blue background, dimension lines and callouts, isometric projection, patent illustration typography",
	...
	"A Minion striding forward carrying a banner, Soviet constructivist poster style, diagonal geometric composition, red and black palette, bold geometric sans-serif lettering",
	...
	"A Minion hunting a dragon, medieval tapestry style, flat woven texture, muted wool colours, decorative Latin border inscription, Bayeux Tapestry composition",
